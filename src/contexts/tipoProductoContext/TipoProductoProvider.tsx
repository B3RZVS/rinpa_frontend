...
export const TipoProductoProvider: React.FC<TipoProductoProviderProps> = ({ children }) => {
  const [loading, setLoading] = useState<boolean>(false);
  const [tipoProductos, setTipoProducto] = useState<TipoProductoInterfaceResponse[]>([])
    ...
    const registerTipoProducto = async (data: CreateTipoProductoInterface) => {
      ...
      const updateTipoProducto = async (data: UpdateTipoProductoInterfece) => {
        ...
        const deleteTipoProducto = async (id: number) => {
          ...
          return (
            <TipoProductoContext.Provider value={contextValue}>{children}
